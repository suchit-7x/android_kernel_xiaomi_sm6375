...
static int gf_pinctrl_init(struct gf_dev *gf_dev)
{
	...
	gf_dev->gf_reset_high = pinctrl_lookup_state(gf_dev->pinctrl_gpios,"xiaomifp_reset_outputhigh");
	...
	gf_dev->gf_reset_low = pinctrl_lookup_state(gf_dev->pinctrl_gpios,"xiaomifp_reset_outputlow");
